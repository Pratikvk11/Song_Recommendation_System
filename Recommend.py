...
data_dict=pickle.load(open(r"D:\Song recommendation\data.pkl","rb"))
...
name_dict=pickle.load(open(r'D:\Song recommendation\names.pkl','rb'))
names=pd.DataFrame(name_dict)
song_dict=pickle.load(open(r'D:\Song recommendation\song_names.pkl','rb'))
song=pd.DataFrame(song_dict)
artists_dict=pickle.load(open(r'D:\Song recommendation\artist_name.pkl','rb'))
